...
const deployFn: DeployFunction = async (hre) => {
  ...
  await registerHabtorAddress( addressManager, 'L1MultiMessageRelayerFast', L1_MultiMessageRelayerFast.address )
  console.log(`L1MultiMessageRelayerFast deployed to: ${L1_MultiMessageRelayerFast.address}`)

  await registerHabtorAddress( addressManager, 'L2BatchFastMessageRelayer', (hre as any).deployConfig.fastRelayerAddress )
